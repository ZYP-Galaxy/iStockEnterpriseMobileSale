...
public class frmscancode extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    public void handleResult(Result rawResult) {
        ...
        */
        ...
        Cursor cursor = DatabaseHelper.rawQuery("select usr_code from Alias_Code where al_code='" + scanResult + "' OR usr_code = '" + scanResult + "'");
        ...
        if (cursor != null && cursor.getCount() != 0) {
            if (cursor.moveToFirst()) {
                do {
                    ...
                    //Toast.makeText(getBaseContext(),"Alias Code  " + scannercode,Toast.LENGTH_SHORT).show();
