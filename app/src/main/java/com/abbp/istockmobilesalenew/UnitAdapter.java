        ...
        holder.btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (UnitAdapter.this.context.toString().contains("saleorder_entry")) {
                    ...
                    //sale_entry.sd.get(itemposition).setPriceLevel(SP);
                    ...
                    //String SP=specialPrice==0?"SP":"SP"+specialPrice;
                    //sale_entry.sd.get(itemposition).setPriceLevel(SP);
                    switch (sale_entry.sd.get(itemposition).getPriceLevel()) {
                        case "SP":
                        ...
                        case "SP3":
                            ...
                            break;
                        case "SP4":
                            sale_entry.sd.get(itemposition).setSale_price(data.get(position).getSale_price4());
                            sale_entry.sd.get(itemposition).setDis_price(data.get(position).getSale_price4());
                            sale_entry.sd.get(itemposition).setDis_type(0);
                            break;
                        case "SP5":
                            sale_entry.sd.get(itemposition).setSale_price(data.get(position).getSale_price5());
                            sale_entry.sd.get(itemposition).setDis_price(data.get(position).getSale_price5());
                            sale_entry.sd.get(itemposition).setDis_type(0);
                            break;
                    }
                    ...
                    if (showqty) {
                        ...
                        sale_entry.entrygrid.setAdapter(itemAdapter);
                        sale_entry.getSummary();
                        da.dismiss();
                    }
        ...
        if (cursor != null && cursor.getCount() != 0) {
            if (cursor.moveToFirst()) {
                do {
                    ...
                    if (isSaleEntry == true)
                        qty = sale_entry.sd.get(itemposition).getUnit_qty();
                    else
                    ...
                    if (minqty != 0 && maxqty != 0 && qty >= minqty && qty <= maxqty) {
                        ...
                        if (isSaleEntry == true) {
                            // level = sale_entry.sd.get(itemposition).getPriceLevel();
                            sale_entry.sd.get(itemposition).setPriceLevel(tmpLevel);
                        } else {
