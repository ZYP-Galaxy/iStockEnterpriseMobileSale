...
public class unitforcode {
    ...
    public unitforcode(int code, String usr_code, int unit_type, int unit, String unitname, String shortdes, double sale_price, double sale_Price1, double sale_price2, double sale_price3, double sale_price4, double sale_price5, double smallest_unit_qty) {
        this.code = code;
    ...
    public void setSale_price4(double sale_price4) {
        this.sale_price4 = sale_price4;
    }
