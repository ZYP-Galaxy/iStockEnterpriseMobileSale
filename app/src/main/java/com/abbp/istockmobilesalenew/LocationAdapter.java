...
public class LocationAdapter extends RecyclerView.Adapter<LocationAdapter.MyViewHolder> {
    ...
    public LocationAdapter(Context context, ArrayList<Location> data, Button btn, AlertDialog da) {
        this.data = data;
    ...
    public void onBindViewHolder(LocationAdapter.MyViewHolder holder, int position) {
        ...
        holder.btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (LocationAdapter.this.context.toString().contains("saleorder_entry")) {
